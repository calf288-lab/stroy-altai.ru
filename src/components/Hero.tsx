import { ArrowDown, MessageSquare, Send, Phone, CheckCircle2, Award, Shield, Trees } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 py-16 lg:py-24 w-full">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Mountain badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#202b23]/90 border border-[#344739] text-[#9fc7a8] text-xs font-semibold backdrop-blur-md">
              <Trees className="w-3.5 h-3.5 text-[#d3a168]" />
              <span>Суровая горная эстетика & натуральный сибирский кедр</span>
            </div>
            ...
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.12] font-heading">
              Строительство домов, бань и усадеб на <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#e3af74] to-[#c78848]">Алтае</span>
            </h1>

            <p className="text-base sm:text-lg text-[#c5d1c8] max-w-2xl leading-relaxed">
              Возводим капитальные дома, кедровые бани, беседки с барбекю, заливаем фундаменты на сложном рельефе и выполняем чистовую отделку под ключ. Горно-Алтайск, Чемал, Манжерок, Белокуриха, Барнаул и Бийск.
            </p>
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#151c17]/90 backdrop-blur-md rounded-2xl border border-[#2e3e31] p-5 sm:p-6 shadow-2xl space-y-4">
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="p-2.5 rounded-xl bg-[#1b241e] border border-[#2b3a2f] flex justify-between items-center">
                  <div>
                    <div className="font-semibold text-white">Внутренняя отделка</div>
                    <div className="text-[11px] text-[#8fa094]">Плитка, теплый пол, дерево</div>
                  </div>
                  <div className="text-right">
                    <span className="font-extrabold text-[#d3a168]">от 18 000 ₽</span>
                ...
                <div className="p-2.5 rounded-xl bg-[#1b241e] border border-[#2b3a2f] flex justify-between items-center">
                  <div>
                    <div className="font-semibold text-white">Фундаменты на рельефе</div>
                    <div className="text-[11px] text-[#8fa094]">Плита, лента, подпорные стены</div>
                  </div>
                  <div className="text-right">
                    <span className="font-extrabold text-[#d3a168]">от 8 500 ₽</span>
                    <div className="text-[10px] text-[#8fa094]">за м³ (работа)</div>
                  </div>
                </div>
              </div>
